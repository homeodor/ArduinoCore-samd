 ...
 */
  ...
  { PORTA,  9, PIO_SERCOM,  (PIN_ATTR_DIGITAL                                ), ADC_Channel17,  NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // SCL:  SERCOM2/PAD[1]
  ...
  { PORTA, 14, PIO_DIGITAL, (PIN_ATTR_NONE                                ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_14 }, // SS:   as GPIO
  { PORTA, 15, PIO_DIGITAL, (PIN_ATTR_NONE                                ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // MISO: SERCOM4/PAD[3]

  { PORTA, 16, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER    ), No_ADC_Channel, PWM2_CH0,   TCC2_CH0,     EXTERNAL_INT_NONE    }, // MOSI: SERCOM1/PAD[0]
  ...
  { PORTA, 20, PIO_SERCOM,  (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), No_ADC_Channel, PWM0_CH6,   TCC0_CH6,     EXTERNAL_INT_NONE    },
  { PORTA, 21, PIO_SERCOM,  (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER_ALT), No_ADC_Channel, PWM0_CH7,   TCC0_CH7,     EXTERNAL_INT_NONE    },
  { PORTA, 22, PIO_DIGITAL, (PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER    ), No_ADC_Channel, PWM4_CH0,   TC4_CH0,      EXTERNAL_INT_NONE    },
  ...
  { PORTB,  7, PIO_ANALOG,  PIN_ATTR_DIGITAL, ADC_Channel7,   NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, 

  { PORTB,  8, PIO_ANALOG,  (PIN_ATTR_DIGITAL                                ), ADC_Channel2,   NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_8 },
  { PORTB,  9, PIO_ANALOG,  (PIN_ATTR_PWM|PIN_ATTR_TIMER                     ), ADC_Channel3,   PWM4_CH1,   TC4_CH1,      EXTERNAL_INT_NONE    },
  ...
  { PORTB, 30, PIO_DIGITAL, PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER, No_ADC_Channel, PWM0_CH0, TCC0_CH0, EXTERNAL_INT_NONE }, 
  { PORTB, 31, PIO_DIGITAL, PIN_ATTR_DIGITAL|PIN_ATTR_PWM|PIN_ATTR_TIMER, No_ADC_Channel, PWM0_CH1, TCC0_CH1, EXTERNAL_INT_NONE },
};
